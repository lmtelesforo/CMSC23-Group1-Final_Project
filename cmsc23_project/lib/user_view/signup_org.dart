                ...
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Text(
                        "Click 'Add Proof' for every new proof",
                        style: TextStyle(
                          fontSize: 14,
                          fontFamily: 'Poppins-Reg',
                          fontWeight: FontWeight.w600,
                        ...
                        child: Stack (
                          children: [
                            ...
                            TextFormField(
                              ...
                              validator: (val) {
                                if (val!.isEmpty) {
                                  return "Please enter your proofs";
                                }
                                if (val.trim().isEmpty) {
                                  return "Please enter your proofs";
                                }
                                if (provider.addressList.length == 0) {
                                  return "Please add your proof";
                                }
                                return null;
                              },
                              style: const TextStyle(
                              ...
                              decoration: InputDecoration(
                                hintText: 'e.g. Date established, SocMed links',
                                hintStyle: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                                  fontFamily: 'Poppins-Reg',
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          final proof = provider.controller7.text;

                          if (proof!.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Please input a proof.'),
                            ),
                          );
                          return;
                          }
                          ...
                          provider.updateProofs(proofsList);

                          print(proofsList);

                          print(provider.proofList);

                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Proof added!'),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            final proofs = provider.proofList;
